...
{
    public class MeatSupplierAdapter : IExternalProviderAdapter
    {
        private readonly HttpClient _httpClient;

        public MeatSupplierAdapter(HttpClient httpClient)
        {
        ...
        public async Task<IEnumerable<Product>> GetProductsAsync(int providerId, int categoryId)
        {
            ...
            // Translate external data into our Core Domain Entity format
        ...
        // Private DTO to map the incoming JSON
